...
TCK::
A war and a test artifact to verify an implementation. See the https://tck/README.asciidoc[readme in the `tck` module] for details on how to build and run the tests.
